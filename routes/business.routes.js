...
router.post("/create-business", isAuth, attachCurrentUser, async (req, res) => {
    ...
    try {
        ...
        await userModel.findByIdAndUpdate({ _id: loggedInUser._id }, { $push: { business: newBusiness._id } })
...
router.get("/profile", isAuth, attachCurrentUser, async (req, res) => {
    ...
    try {
        ...
        const business = await BusinessModel.findById(loggedInUser.business).populate('onwer')
